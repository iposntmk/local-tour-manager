...
export type DestinationFreeRow = Database['public']['Tables']['destinations_free']['Row'];
export type DestinationFreeUpdate = Database['public']['Tables']['destinations_free']['Update'];
