export const TOUR_SHEET_COLUMNS = [
  ...
  { key: 'date', width: 10, label: 'ngày' },
  { key: 'service', width: 24, label: 'vé/ăn/uống/chi phí' },
  { key: 'serviceDate', width: 8, label: 'ngày' },
  { key: 'price', width: 12, label: 'giá vé/đơn giá' },
  { key: 'quantity', width: 10, label: 'số khách/ số ngày/ tổng số chai nước uống' },
  { key: 'total', width: 12, label: 'thành tiền' },
  { key: 'location', width: 22, label: 'Địa điểm/tỉnh' },
  { key: 'locationDate', width: 8, label: 'ngày' },
  { key: 'days', width: 8, label: 'số ngày' },
  { key: 'ctp', width: 8, label: 'CTP' },
  { key: 'ctpTotal', width: 10, label: 'thành tiền' },
