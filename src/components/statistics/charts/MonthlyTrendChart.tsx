...
const SERIES = [
  ...
  { key: 'totalShopTipAllow', label: 'S+T+A', color: '#f97316' }, // orange
  { key: 'totalIncomeWithoutCarHotel', label: 'Thu nhập (-xe/ngủ)', color: '#22c55e' }, // green
] as const;
  ...
  return (
    <section>
      <SectionHeader
        ...
        description="So sánh Final Total, S+T+A, Thu nhập (-xe/ngủ) theo tháng — rê chuột để xem chi tiết"
      />
