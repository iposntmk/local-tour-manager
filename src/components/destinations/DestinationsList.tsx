...
import type { TouristDestination, Province } from '@/types/master';
...
interface DestinationsListProps {
  ...
  onFilterChange: (field: keyof DestinationFilters, value: string) => void;
  canEdit: boolean;
  canCreate: boolean;
  canDelete: boolean;
  isAdmin: boolean;
  ...
  onOpen: (destination: TouristDestination) => void;
  onDuplicate: (id: string) => void;
  onDelete: (destination: TouristDestination) => void;
  onShareToggle: (destination: TouristDestination) => void;
}
          ...
          <tbody>
            {destinations.map((destination) => (
              ...
              >
                ...
                <td className="p-4 text-muted-foreground">{formatCurrency(destination.price)}</td>
